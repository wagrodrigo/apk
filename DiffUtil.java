...
public class DiffUtil {
    ...
    public static DiffResult calculateDiff(Callback callback, boolean z) {
        ...
        while (!arrayList2.isEmpty()) {
            ...
            if (diffPartial != null) {
                ...
                diffPartial.f37x += range.oldListStart;
                diffPartial.f38y += range.newListStart;
                Range range2 = arrayList3.isEmpty() ? new Range() : (Range) arrayList3.remove(arrayList3.size() - 1);
                range2.oldListStart = range.oldListStart;
                range2.newListStart = range.newListStart;
                if (diffPartial.reverse) {
                    range2.oldListEnd = diffPartial.f37x;
                    range2.newListEnd = diffPartial.f38y;
                } else if (diffPartial.removal) {
                    range2.oldListEnd = diffPartial.f37x - 1;
                    range2.newListEnd = diffPartial.f38y;
                } else {
                    range2.oldListEnd = diffPartial.f37x;
                    range2.newListEnd = diffPartial.f38y - 1;
                }
                arrayList2.add(range2);
                if (!diffPartial.reverse) {
                    range.oldListStart = diffPartial.f37x + diffPartial.size;
                    range.newListStart = diffPartial.f38y + diffPartial.size;
                } else if (diffPartial.removal) {
                    range.oldListStart = diffPartial.f37x + diffPartial.size + 1;
                    range.newListStart = diffPartial.f38y + diffPartial.size;
                } else {
                    range.oldListStart = diffPartial.f37x + diffPartial.size;
                    range.newListStart = diffPartial.f38y + diffPartial.size + 1;
                }
    ...
    private static android.support.p007v7.util.DiffUtil.Snake diffPartial(android.support.p007v7.util.DiffUtil.Callback r22, int r23, int r24, int r25, int r26, int[] r27, int[] r28, int r29) {
        /*
            r0 = r22
            r3 = r27
            r4 = r28
        ...
        L_0x015a:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p007v7.util.DiffUtil.diffPartial(android.support.v7.util.DiffUtil$Callback, int, int, int, int, int[], int[], int):android.support.v7.util.DiffUtil$Snake");
    }
    ...
    public static class DiffResult {
        ...
        private void findMatchingItems() {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                int i3 = snake.f37x + snake.size;
                int i4 = snake.f38y + snake.size;
                ...
                for (int i5 = 0; i5 < snake.size; i5++) {
                    int i6 = snake.f37x + i5;
                    int i7 = snake.f38y + i5;
        ...
        private boolean findMatchingItem(int i, int i2, int i3, boolean z) {
            ...
            while (i3 >= 0) {
                ...
                int i6 = snake.f37x + snake.size;
                int i7 = snake.f38y + snake.size;
                int i8 = 4;
                if (z) {
        ...
        public void dispatchUpdatesTo(ListUpdateCallback listUpdateCallback) {
            ...
            for (int size = this.mSnakes.size() - 1; size >= 0; size--) {
                ...
                for (int i6 = i3 - 1; i6 >= 0; i6--) {
                    if ((this.mOldItemStatuses[snake.f37x + i6] & 31) == 2) {
                        batchingListUpdateCallback.onChanged(snake.f37x + i6, 1, this.mCallback.getChangePayload(snake.f37x + i6, snake.f38y + i6));
                    }
                }
                i = snake.f37x;
                i2 = snake.f38y;
