...
import android.support.p004v4.view.NestedScrollingParent;
import android.support.p004v4.view.NestedScrollingParentHelper;
...
import p060io.fabric.sdk.android.services.settings.SettingsJsonConstants;
...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = {C0384R.attr.actionBarSize, 16842841};
    ...
    public void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0384R.C0386id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0384R.C0386id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0384R.C0386id.action_bar));
        }
    }
