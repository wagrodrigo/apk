...
public class ActionBarContainer extends FrameLayout {
    ...
    public ActionBarContainer(Context context, AttributeSet attributeSet) {
        ...
        TypedArray obtainStyledAttributes = context.obtainStyledAttributes(attributeSet, C0384R.styleable.ActionBar);
        this.mBackground = obtainStyledAttributes.getDrawable(C0384R.styleable.ActionBar_background);
        this.mStackedBackground = obtainStyledAttributes.getDrawable(C0384R.styleable.ActionBar_backgroundStacked);
        this.mHeight = obtainStyledAttributes.getDimensionPixelSize(C0384R.styleable.ActionBar_height, -1);
        if (getId() == C0384R.C0386id.split_action_bar) {
            this.mIsSplit = true;
            this.mSplitBackground = obtainStyledAttributes.getDrawable(C0384R.styleable.ActionBar_backgroundSplit);
        }
    ...
    public void onFinishInflate() {
        ...
        this.mActionBarView = findViewById(C0384R.C0386id.action_bar);
        this.mContextView = findViewById(C0384R.C0386id.action_context_bar);
    }
    ...
    public void onLayout(boolean r6, int r7, int r8, int r9, int r10) {
        ...
        L_0x00cb:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p007v7.widget.ActionBarContainer.onLayout(boolean, int, int, int, int):void");
    }
}
