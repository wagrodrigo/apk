...
import android.support.p004v4.graphics.drawable.DrawableWrapper;
...
public class DrawableUtils {
    ...
    public static android.graphics.Rect getOpticalBounds(android.graphics.drawable.Drawable r10) {
        /*
            ...
            android.graphics.drawable.Drawable r10 = android.support.p004v4.graphics.drawable.DrawableCompat.unwrap(r10)     // Catch:{ Exception -> 0x0098 }
        ...
        L_0x009f:
            ...
            return r10
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p007v7.widget.DrawableUtils.getOpticalBounds(android.graphics.drawable.Drawable):android.graphics.Rect");
    }
    ...
    public static boolean canSafelyMutateDrawable(@NonNull Drawable drawable) {
        ...
        if (drawable instanceof DrawableContainer) {
            ...
            if (drawable instanceof android.support.p007v7.graphics.drawable.DrawableWrapper) {
                return canSafelyMutateDrawable(((android.support.p007v7.graphics.drawable.DrawableWrapper) drawable).getWrappedDrawable());
            }
