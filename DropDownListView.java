...
import android.support.p004v4.widget.ListViewAutoScrollHelper;
...
class DropDownListView extends ListViewCompat {
    ...
    public DropDownListView(Context context, boolean z) {
        super(context, (AttributeSet) null, C0384R.attr.dropDownListViewStyle);
        this.mHijackFocus = z;
        setCacheColorHint(0);
    }
    ...
    public boolean onForwardedEvent(android.view.MotionEvent r8, int r9) {
        ...
        L_0x0069:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.p007v7.widget.DropDownListView.onForwardedEvent(android.view.MotionEvent, int):boolean");
    }
